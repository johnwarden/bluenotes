...
/**
 * Blue Notes mark used for the grow/exit overlay. Must stay in sync with
 * `assets/logo.svg` and the HTML splash so the handoff never shows the
 * Bluesky butterfly.
 */
...
export const Logo = forwardRef(function LogoImpl(props: SvgProps, ref) {
  ...
  return (
    <Svg
      ...
      <Path fill={props.fill || '#fff'} d={BLUE_NOTES_MARK} />
    </Svg>
  )
})
