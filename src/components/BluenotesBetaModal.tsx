...
interface BluenotesBetaModalProps {
  control: {
    isOpen: boolean
    open: () => void
    close: () => void
...
export function BluenotesBetaModal({control}: BluenotesBetaModalProps) {
  const {_} = useLingui()
            ...
            <View style={[a.gap_2xl, a.align_center, a.p_4xl]}>
              ...
              <View
                ...
                <Text
                  ...
                  <Trans>Welcome to the Bluenotes Beta</Trans>
                </Text>
                <Text
                  style={[
                    a.text_md,
                    a.text_center,
                    {color: '#405168', lineHeight: 24, marginTop: 16},
                  ]}>
                  <Trans>
                    Bluenotes is a clone of the Bluesky social app, with the
                    addition of Community Notes.
                  </Trans>
                </Text>
                <Pressable
              ...
              <View style={[a.gap_md, a.align_center]}>
                <View>
                  ...
                  <Button
                    ...
                    label={_(msg`Explore the app without signing in`)}
                    size="large"
                    color="primary"
                    variant="ghost"
                    ...
                    {({hovered}) => (
                      <ButtonText
                        ...
                        <Trans>Explore the app without signing in</Trans>
                      </ButtonText>
                    )}
                  </Button>
                </View>
